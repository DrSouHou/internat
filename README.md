...
A modern, responsive web application dashboard for managing the **SupTech Internat** (student dormitories) for **SupTech Santé** and **SupTech Environnement** (FRDISI / UIB) located in Mohammedia.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/suptech-internat.git
   ```
...
* **Admin Demo:** `admin@suptech.ma` (Password: `••••••••`)
* **Resident Demo:** `fatima@suptech.ma` (Password: `••••••••`)
